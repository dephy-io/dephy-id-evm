...
export type scalarAssignableBy<T extends $.ScalarType> =
  ...
  T extends _default.$Hash ? _default.$Hash : 
  T extends _default.$EthAddress ? _default.$EthAddress : 
...
type getSharedParentScalar<A, B> =
  ...
  A extends _fts.$ElasticLanguage ?
    ...
    never
  :
  A extends _default.$Hash ?
    B extends _default.$Hash ?
    B
    :
    never
  :
  A extends _default.$EthAddress ?
    B extends _default.$EthAddress ?
    B
    :
    never
  :
...
function getSharedParentScalar<A extends $.ScalarType, B extends $.ScalarType>(a: A, b: B): A | B {
  ...
  if (a.__name__ === "default::Hash") {
    if(b.__name__ === "default::Hash") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
  if (a.__name__ === "default::EthAddress") {
    if(b.__name__ === "default::EthAddress") {
      return b;
    }
    throw new Error(`Types are not castable: ${a.__name__}, ${b.__name__}`);
    }
